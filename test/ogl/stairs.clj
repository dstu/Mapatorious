...
(defn display [[delta time] state]
  ...
  (draw-quads          ;; x y z
    (color 1 1 1)
      ...
      (make-square 0 1 0.25 0.5)
      (make-square 0 2 0.5 0.5)
      (make-square 0 3 0.75 0.5)
      (make-square 0 4 1 0.5)
      (make-square 1 0 0 0.5)
      (make-square 1 1 0.5 0.5)
      (make-square 1 2 1 0.5)
      (make-square 1 3 1.5 0.5)
      (make-square 1 4 2 0.5)
      (make-square 2 0 0 0.5)
      (make-square 2 1 1 0.5)
      (make-square 2 2 2 0.5)
      (make-square 2 3 4 0.5)
      (make-square 2 4 8 0.5)))
